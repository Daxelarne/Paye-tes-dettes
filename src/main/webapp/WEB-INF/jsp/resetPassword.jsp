...
<body style="background-color: #eee;" >
	...
	if (error != null) {
		if ("passwordNotSecure".equals(error)) { %>
		<div class="alert alert-danger" role="alert">
	  		Votre mot de passe n'est pas assez sécurisé !
		</div>
	<% } else if ("invalidSecurityKey".equals(error)) { %>
		<div class="alert alert-danger" role="alert">
	  		Votre clé de sécurité est invalide, changement de mot de passe impossible.
	  		Veuillez recommencer la procédure de réinitialisation depuis la page de connexion.
		</div>
	  <% }
	}%>
							...
							<div class="col-lg-6">
								<div class="card-body p-md-5 mx-md-4">
									...
									<div class="text-center">
										<img src="https://zupimages.net/up/23/11/slog.png" style="width: 150px; height: 145px" alt=" " />
										<h4 class="mt-1 mb-5 pb-1">Paye tes dettes</h4>
									</div>

									<form:form method="POST" action="/user/resetPassword" id="registerForm" modelAttribute="userFound">
										<p>Réinitialiser mon mot de passe</p>

										<form:input class="form-control " type="text" path="id" value="${ user.getId() }" hidden="true" />

										<div class="form-outline mb-4">
											<form:input path="newPassword" name="password" type="password" id="password"
